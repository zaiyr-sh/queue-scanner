...
public class SecurityService extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().
                authorizeRequests()
                .antMatchers("/", "/api/client/", "/api/client", "/api/client/{id}", "/api/client/{id}/", "/api/client/all/", "/api/client/all", "/api/client/ip/", "/api/client/ip", "/api/client/ip/{ipAddress}", "/api/client/ip/{ipAddress}/",
